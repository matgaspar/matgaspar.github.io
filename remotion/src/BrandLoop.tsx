...
const ORBS: Orb[] = [
  { x: 20, y: 26, r: 600, color: '#3b82f6', phase: 0.0, drift: 80 },
  { x: 80, y: 20, r: 520, color: '#0ea5e9', phase: 1.2, drift: 95 },
  { x: 66, y: 76, r: 680, color: '#22d3ee', phase: 2.4, drift: 85 },
  { x: 26, y: 82, r: 460, color: '#2563eb', phase: 3.6, drift: 105 },
  { x: 50, y: 48, r: 540, color: '#38bdf8', phase: 5.0, drift: 65 },
]
...
export const BrandLoop: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: 'linear-gradient(135deg, #070a14 0%, #0f1730 100%)' }}>
      {ORBS.map((o, i) => {
